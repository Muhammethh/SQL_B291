...
--CREATE DATABASE techproed; aynı isimli database oluşturulamaz
...
--5-Tabloyu silme - DDL(data definition language)
...
--7- Data Okuma / Cekme
--a) Tablodaki tüm dataları görüntüleme - DQL(data query language)
...
INSERT INTO students (name,grade)VALUES ('Ayşe Can',97.4);
SELECT * FROM students;
...
INSERT INTO actors VALUES(1002,'şener şen', 'aktor@gmail.com'); --mail unique olmalıydı